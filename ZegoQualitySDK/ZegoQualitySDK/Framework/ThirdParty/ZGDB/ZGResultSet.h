...
/** Represents the results of executing a query on an @c ZGDatabase .
...
@interface ZGResultSet : NSObject

@property (nonatomic, retain, nullable) ZGDatabase *parentDB;
...
/** `ZGStatement` used by result set. */

@property (atomic, retain, nullable) ZGStatement *statement;
