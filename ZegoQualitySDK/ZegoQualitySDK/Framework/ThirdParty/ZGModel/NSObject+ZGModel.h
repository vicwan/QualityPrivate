 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `ZGModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface ZGAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation ZGAuthor
     @end
 
     @interface ZGBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) ZGAuthor *author;
     @end
     ...
     int main() {
         ...
         ZGBook *book = [ZGBook zego_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book zego_modelToJSONString];
 ...
 @code
     @interface ZGShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation ZGShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self zego_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self zego_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self zego_modelCopy]; }
     - (NSUInteger)hash { return [self zego_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self zego_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (ZGModel)
 ...
 */
+ (nullable instancetype)zego_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)zego_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)zego_modelToJSONObject;
 ...
 */
- (nullable NSData *)zego_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)zego_modelToJSONString;
 ...
 */
+ (nullable NSArray *)zego_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
+ (nullable NSDictionary *)zego_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<ZGModel>' to your class header.
 */
@protocol ZGModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class ZGShadow, ZGBorder, ZGAttachment;
 
        @interface ZGAttributes
        @property NSString *name;
        ...
        @implementation ZGAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [ZGShadow class],
                     @"borders" : ZGBorder.class,
                     @"attachments" : @"ZGAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class ZGCircle, ZGRectangle, ZGLine;
 
        @implementation ZGShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [ZGCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [ZGRectangle class];
